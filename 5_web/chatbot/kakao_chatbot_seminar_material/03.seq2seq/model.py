...
class seq2seq:
    ...
    def _build_net(self):
        ...
        # bidriection RNN (foward, backward)
        ...
        # embedding : one hot encoding의 단점을 상쇄
        ...
        # 정보를 다 받은 encoder의 final starter_learning_rate
        # GO 111111(tf.ones)라는 입력을 받아서 decoder cell에 입력됨. 답을 출력하기 시작.
